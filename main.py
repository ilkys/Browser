...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.setWindowIcon(QtGui.QIcon('img\ico.ico'))
        self.showMaximized()
        self.show()
        ...
        self.webview.load(QUrl('google.com'))
        ...
        back_button = QAction(QIcon(r'img\back.png'), 'Back', self)
        next_button = QAction(QIcon(r'img\forward.png'), 'Forward', self)
        add_button = QAction(QIcon(r'img\google.png'), 'Google', self)
        reload_button = QAction(QIcon(r'img\reload.png'), 'Reload', self)
        self.webview.load(QUrl("google.com"))
